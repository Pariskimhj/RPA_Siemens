...
"}")
        ...
        self.btn_Asset_list = QPushButton(self.frame_2)
        self.btn_Asset_list.setObjectName(u"btn_Asset_list")
        self.btn_Asset_list.setMinimumSize(QSize(0, 30))
        self.btn_Asset_list.setFont(font1)
        self.btn_Asset_list.setCursor(QCursor(Qt.PointingHandCursor))

        self.verticalLayout_3.addWidget(self.btn_Asset_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_Asset_list.setText(QCoreApplication.translate("MainWindow", u"Asset_list", None))
